...
const Jee = () => {
  ...
  useEffect(() => {
    const fetchJeeData = async () => {
      try {
        const response = await fetch('http://localhost:3000/educational-services/jee');
        if (!response.ok) {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          ...
          <p className="text-gray-600 mt-1">JEE Faculty Members</p>
        </div>
      </div>
