...
const CompetativeExaom = () => {
  ...
  useEffect(() => {
    const fetchExamData = async () => {
      try {
        const response = await fetch('http://localhost:3000/educational-services/competitive-exams');
        if (!response.ok) {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          ...
          <p className="text-gray-600 mt-1">Expert Faculty for Competitive Exams</p>
        </div>
      </div>
...
export default CompetativeExaom;
