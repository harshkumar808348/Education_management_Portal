...
const Class10AdminPanel = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    teacherId: '',
    description: '',
    amount: ''  // Changed to lowercase for consistency
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://education-management-portal-1.onrender.com/MainAdmin/Class10adminPannel', {
        method: 'POST',
        body: submitFormData,
      });
...
export default Class10AdminPanel;