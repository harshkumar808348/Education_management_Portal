...
const CompetitiveExamAdminPanel = () => {
  // Form state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/MainAdmin//CompetativePannel', {
        method: 'POST',
        body: submitFormData,
      });
...
export default CompetitiveExamAdminPanel;
