...
const Class10Management = () => {
  ...
  const fetchTeachers = async () => {
    try {
      const response = await fetch('http://localhost:3000/MainAdmin/class10');
  ...
  const handleSave = async (id) => {
    try {
      const response = await fetch(`http://localhost:3000/MainAdmin/class10/${id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Class 10 Teachers Management</h1>
...
export default Class10Management;