...
const Class11AdminPanel = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/MainAdmin/Class11adminPannel', {
        method: 'POST',
        body: submitFormData,
      });
...
export default Class11AdminPanel;
